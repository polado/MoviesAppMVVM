...
public class FavouriteMoviesFragment extends ParentFragment {
    ...
    public FavouriteMoviesFragment(MoviesListViewModel moviesListViewModel) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        moviesListViewModel.getFavouriteMoviesData().observe(this, new Observer<List<Movie>>() {
            @Override
        ...
        rvMovieList.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!loading && (totalItemCount - visibleItemCount)
                    ...
                    moviesListViewModel.getMorePopularMovies(pageNo);
                    loading = true;
                }
            }
        });
